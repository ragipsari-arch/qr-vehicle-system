...
exports.notificationSimulatorLogs = void 0;
exports.getSimulatorLogs = getSimulatorLogs;
exports.clearSimulatorLogs = clearSimulatorLogs;
exports.sendNotification = sendNotification;
// In memory notification log for the simulation overlay
exports.notificationSimulatorLogs = [];
function getSimulatorLogs() {
    return exports.notificationSimulatorLogs;
}
function clearSimulatorLogs() {
    exports.notificationSimulatorLogs.length = 0;
}
/**
...
async function sendNotification(payload) {
    ...
    if (payload.subCategory)
        alertMessage += `Ayrıntı: ${subCategoryTitle}\n`;
    if (payload.customText)
        alertMessage += `Mesaj: "${payload.customText}"\n`;
    ...
    exports.notificationSimulatorLogs.unshift({
        id: Math.random().toString(36).substring(2, 9),
        ...logEntry
    });
    // Limit simulator logs size to 50
    if (exports.notificationSimulatorLogs.length > 50) {
        exports.notificationSimulatorLogs.pop();
    }
